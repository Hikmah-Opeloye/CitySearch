...
import { IcityFinder } from "./interface.js";
...
export class FindCity implements IcityFinder {
  ...
  searchLetters(searchstring: string, filteredarray: string[]): string[] {
    //for each item in the array
    return filteredarray.map((letter: string) => {
